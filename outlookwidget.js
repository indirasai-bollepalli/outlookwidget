(function () {
    ...
    class outlookwidgetWidget extends HTMLElement {
        ...
        async sendEmailWithPdf(storyContent) {
            ...
            const sendGridApiKey = '${{ secrets.SENDGRID_API_KEY }}';  // Replace with your actual SendGrid API key
            ...
            const emailData = {
                ...
                from: { email: 'indirasai.bollepalli@nagarro.com' }, // Replace with your email address
                content: [{
                    type: 'text/html',
